...
Rectangle{
    ...
    property string onSrc: "qrc:/QmlFile/QuickControl/img/on.png"
    property string offSrc: "qrc:/QmlFile/QuickControl/img/off.png"
    property string checkedSrc: "qrc:/QmlFile/QuickControl/img/check.png"
    property string uncheckSrc: "qrc:/QmlFile/QuickControl/img/uncheck.png"
        ...
        Row{
            ...
            Canvas{
                ...
                onPaint: {
                    ...
                    // setup the stroke
                    ctx.strokeStyle = Qt.rgba(0.6,0.6,0.6,1)
                    ctx.lineWidth=1
                    // create a path
                    ctx.beginPath()
